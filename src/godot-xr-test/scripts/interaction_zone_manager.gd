...
@export var visualize_zone: bool = true
@export var zone_material: Material

# Visual debugging
@export var debug_mode: bool = true
@export var show_hand_markers: bool = true
...
func _setup_cylinder_visualization() -> void:
    ...
    cylinder.top_radius = cylinder_radius  # Constant radius
    cylinder.bottom_radius = cylinder_radius  # Constant radius
